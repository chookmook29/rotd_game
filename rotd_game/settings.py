"""
Django settings for rotd_game project.
...
SECRET_KEY = 'cc%nml6g9947t=ko82i9+m7d-2svlg^u*0@p^yr4pu)jvm8q(1'
...
WSGI_APPLICATION = 'rotd_game.wsgi.application'
